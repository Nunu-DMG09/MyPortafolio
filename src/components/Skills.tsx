...
export default function Skills() {
	return (
		<section id="skills" className="max-w-4xl mx-auto px-6 py-12 reveal" aria-labelledby="skills-title">
			<h2 id="skills-title" className="text-2xl font-bold mb-6 text-center" style={{ color: "#22c55e" }}>
				Habilidades
			</h2>
			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
				{sections.map((sec) => (
					<div key={sec.title} className="flex flex-col items-center">
						<h3 className="text-lg font-semibold mb-3 text-center" style={{ color: "#ffffff" }}>{sec.title}</h3>
