...
const projects: Project[] = [
  {
    ...
    description: "Sistema de denuncias para atención ciudadana.",
    image: "https://source.unsplash.com/collection/190727/800x600?sig=1",
    techs: ["React", "JavaScript", "Tailwind", "PHP", "CodeIgniter"],
    repo: "#",
    demo: "#",
    type: "colaborativo",
  },
  {
    id: 2,
    title: "Corporación KM GROUP - Página web",
    description: "Landing corporativa con CMS ligero.",
    image: "https://source.unsplash.com/collection/190727/800x600?sig=2",
    techs: ["HTML", "CSS", "JavaScript", "PHP", "Astro"],
    repo: "#",
    demo: "#",
    type: "hosteado",
  },
  {
    ...
    description: "Landing rápida para presentación de servicios.",
  ...
  },
  {
    ...
    description: "E-commerce básico para venta de servicios.",
    image: "https://source.unsplash.com/collection/190727/800x600?sig=4",
    techs: ["React", "JavaScript", "Express", "MySQL"],
    repo: "#",
    demo: "#",
    type: "hosteado",
  },
  {
    id: 5,
    title: "NunuMedic",
    description: "App de citas médicas sencilla.",
    image: "https://source.unsplash.com/collection/190727/800x600?sig=5",
    techs: ["MySQL", "Express", "React", "Tailwind", "JavaScript"],
    repo: "#",
    demo: "#",
    type: "personal",
  },
  {
    id: 6,
    title: "Ecolim SAC",
    description: "Portal informativo para empresa ambiental.",
    image: "https://source.unsplash.com/collection/190727/800x600?sig=6",
    techs: ["AndroidStudio", "Java", "SQLite"],
    repo: "#",
    demo: "#",
    type: "personal",
  },
...
const getIcon = (tech: string) => {
  switch (tech) {
    case "React":
      return <FaReact size={ICON_SIZE} color={colorMap.React} />;
    case "Node":
    case "Express":
      return <FaNodeJs size={ICON_SIZE} color={colorMap.Node} />;
    case "TypeScript":
      return <SiTypescript size={ICON_SIZE} color={colorMap.TypeScript} />;
    case "Tailwind":
    case "Tailwindcss":
      return <SiTailwindcss size={ICON_SIZE} color={colorMap.Tailwind} />;
    case "Next.js":
      return <SiNextdotjs size={ICON_SIZE} color={colorMap["Next.js"]} />;
    case "Prisma":
      return <SiPrisma size={ICON_SIZE} color={colorMap.Prisma} />;
    case "Postgres":
    case "PostgreSQL":
      return <SiPostgresql size={ICON_SIZE} color={colorMap.Postgres} />;
    case "Astro":
      return <SiAstro size={ICON_SIZE} color={colorMap.Astro} />;
    case "MDX":
      return <SiMarkdown size={ICON_SIZE} color={colorMap.MDX} />;
    case "GraphQL":
      return <SiGraphql size={ICON_SIZE} color={colorMap.GraphQL} />;
    case "HTML":
      return <SiHtml5 size={ICON_SIZE} color={colorMap.HTML} />;
    case "CSS":
      return <SiCss3 size={ICON_SIZE} color={colorMap.CSS} />;
    case "JavaScript":
      return <SiJavascript size={ICON_SIZE} color={colorMap.JavaScript} />;
    case "PHP":
      return <SiPhp size={ICON_SIZE} color={colorMap.PHP} />;
    case "MySQL":
      return <SiMysql size={ICON_SIZE} color={colorMap.MySQL} />;
    case "AndroidStudio":
      return <SiAndroid size={ICON_SIZE} color={colorMap.AndroidStudio} />;
    case "SQLite":
      return <SiSqlite size={ICON_SIZE} color={colorMap.SQLite} />;
    default:
...
export default function Proyectos() {
  ...
  return (
    <section className="max-w-6xl mx-auto px-6 py-16" aria-labelledby="projects-title">
      <h2 id="projects-title" className="text-4xl md:text-5xl font-bold text-center mb-4" style={{ color: "var(--text-100)" }}>
        Proyectos
      </h2>
        ...
        {visible.map((p) => (
          <article key={p.id} className="bg-[rgba(255,255,255,0.02)] rounded-lg overflow-hidden shadow-sm">
            ...
            <div className="p-4">
              ...
              {p.description && <p className="mt-1 text-sm" style={{ color: "var(--muted-300)" }}>{p.description}</p>}
